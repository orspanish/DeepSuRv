...
This demonstration gives a condensed tutorial of how to train a DeepSuRv model,
make predictions, and compute a bootstrap C-index. For more information on this,
please refer to this [applied tutorial]( https://orspanish.github.io/DeepSuRv/articles/DeepSuRv_tutorial.html).

### Data Set-up
Begin by loading a dataset and selecting a few features, along with survival
...
Lastly, the model's concordance index and bootstrap confidence interval can be
estimated.
