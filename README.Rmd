...
The survival datasets used in this package are provided by the
[**survival-datasets** repository](https://github.com/thecml/survival-datasets),
which requires Python ≥ 3.8 and other packages (e.g., NumPy, pandas,
scikit-survival, shap, PyArrow).
