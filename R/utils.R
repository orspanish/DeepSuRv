...
#'
#' @param model A model-like object containing a method that returns the predicted log hazard.
#' @param X A numeric matrix or data frame of input features, with one row per subject and one column per feature
